...
export const qaItems: QAItem[] = [
  ...
  {
    cat: 'sleep',
    q: 'What is a normal sleep schedule for a 4-5 week old baby?',
    a: "At 4-5 weeks, your baby is still too young for a predictable schedule - circadian rhythms haven't developed yet, so sleep is driven by hunger and tiredness rather than the clock. What is consistent at this age is the pattern, not the timing: total sleep of around 14-17 hours across 24 hours, wake windows of roughly 45-60 minutes, and feeds every 2-3 hours (including overnight).\n\nA typical stretch might look like: wake and feed (20-30 min), a short awake window, then back to sleep for 45 minutes to 2 hours - repeated around the clock. Evenings are often harder, with cluster feeding and more unsettled behaviour common between 4pm and 10pm.\n\nRather than chasing a fixed schedule at this age, watch tiredness cues (yawning, glazed eyes, jerky movements) and aim to get your baby down within their wake window before they become overtired. Logging feeds and sleep in PAM's daily tracker over a few days usually reveals your baby's own rhythm, even before a 'schedule' exists.",
  },
  {
    cat: 'sleep',
    q: 'What do newborn sleep patterns look like week by week?',
    a: "Newborn sleep changes fast in the first two months, though the pace varies from baby to baby:\n\n• Week 1-2: sleep is almost entirely feed-driven - 16-18 hours a day in 1-3 hour bursts, no distinction between day and night\n• Week 3-4: total sleep starts to settle slightly (14-17 hours), wake windows stretch to around 45-60 minutes, evenings often become noticeably more unsettled (the 'witching hour')\n• Week 5-6: some babies begin showing the first hints of a longer overnight stretch (3-4 hours); a light day/night distinction can start to emerge\n• Week 7-8: wake windows lengthen further (up to 75-90 minutes), and a loose, more predictable pattern of naps often becomes visible\n\nThese ranges are guides, not milestones to hit on schedule - two healthy babies at the same age can have very different patterns. What matters more than matching a chart is whether your baby is feeding well, gaining weight, and generally settleable. PAM's daily tracker logs sleep and feed times automatically, so you can see your own baby's week-by-week pattern emerge rather than relying on generic averages.",
  },
  {
    cat: 'sleep',
    q: 'What is the difference between an overtired and undertired baby?',
    a: "Both make settling harder, but for opposite reasons. An overtired baby has been awake too long - their body releases cortisol and adrenaline as a stress response, which paradoxically makes it harder to fall and stay asleep. Signs include fussiness that escalates rather than settles, arching or stiffening, difficulty latching, and short, restless naps.\n\nAn undertired baby hasn't been awake long enough to build sufficient 'sleep pressure'. Signs include resisting sleep with no obvious distress, playing or chatting rather than settling, and taking a long time to fall asleep despite seeming calm.\n\nThe fix for both is the same lever: wake windows appropriate for your baby's age (see PAM's wake window guide above). Too far under the window and they're undertired; too far over and they tip into overtired - often quite suddenly, which is why the window between 'ready for sleep' and 'overtired' can feel narrow. Tracking wake times against how well each sleep went in PAM's daily tracker is the fastest way to find your specific baby's sweet spot, since these ranges vary meaningfully between babies.",
  },
  {
    cat: 'sleep',
