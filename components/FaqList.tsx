...
const items: Faq[] = [
  ...
  { cat: 'pricing', q: "What's included in the free trial?", a: "Five days of full access to everything — Smart Lists, the Daily Tracker, Memories, Family & Kids Info and Ask PAM. No credit card needed to start." },
