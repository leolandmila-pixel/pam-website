        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="socials">
              <a href="https://instagram.com/pam.app" target="_blank" rel="noreferrer" aria-label="Instagram">
              ...
              <a href="https://tiktok.com/@pam.app" target="_blank" rel="noreferrer" aria-label="TikTok">
              ...
              <a href="mailto:hello@pamapp.com.au" aria-label="Email">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link href="/#showcase">Ask PAM</Link></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Support</h4>
