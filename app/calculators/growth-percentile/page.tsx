...
import { growthPercentileCalculatorMetadata } from '../../metadata'
...
export const metadata: Metadata = growthPercentileCalculatorMetadata

const breadcrumb = buildBreadcrumbSchema([
  { name: 'Home', url: 'https://parentaladminmanager.com' },
  { name: 'Calculators', url: 'https://parentaladminmanager.com/calculators' },
  { name: 'Growth Percentile Calculator', url: 'https://parentaladminmanager.com/calculators/growth-percentile' },
])
